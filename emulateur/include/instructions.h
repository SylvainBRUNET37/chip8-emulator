 ...
 * \param display écran où effacer l'affichage
 */
 ...
 * \param processor processeur dans lequel faire l'instruction
 */
...
/**
 * \brief Dessine un sprite de n octets commençant à l'emplacement de mémoire I à (Vx, Vy) et définir VF = collision
 *        Les résultats sont stockés dans Vx
 * \param processor processeur dans lequel faire l'instruction
 * \param RAM ram dans laquel chercher les sprites représentatifs
 * \param display structure (représentant l'écran) dans laquel le sprite devra être dessiné
 ...
 * \param processor processeur dans lequel faire l'instruction
 * \param keyboard clavier où lire la touche
...
/**
 * \brief Attend qu'une touche soit utilisée et enregistre sa valeur dans Vx
 * \param processor processeur dans lequel faire l'instruction
 * \param keyboard clavier où lire la touche
 * \param x indice de la destination
 * \return 0 si il n'y a pas eu d'erreur, 1 si x superieur à 16
